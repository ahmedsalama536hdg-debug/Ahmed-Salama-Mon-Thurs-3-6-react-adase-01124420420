  ...
  const [allData, setallData] = useState(
    {
      posts: [
        ...
        },
        {
          ...
          title:  "  تعرف علي اساسيات إعدادات الكاميرا: مثلث التعريض الضوئي ",
          excerpt:
...
window.scrollTo({
  ...
  let { posts, categories, siteInfo } = allData;
  console.log(posts);
  ...
  return (
    <div className="min-h-screen overflow-x-hidden w-full max-w-full ">
      ...
      <section id="?" className="relative bg-black text-white min-h-screen flex flex-col justify-center items-center px-4 py-16 overflow-hidden mt-7">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-45" />
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          {/* Top Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-700/10 border border-amber-700 text-sm mb-8 text-amber-400">
            <div className="flex items-center gap-2">
              <i class="fa-solid fa-circle  text-amber-700 text-[6px] "></i>

              <i class="fa-solid fa-circle fa-fade text-amber-700 text-[9px] drop-shadow-[0_0_8px_rgba(217,119,6,0.8)]"></i>
            </div>

            <span className="text-white">مرحباً بك في عدسة</span>
          </div>
          {/* Main Heading */}
          <h1 className="text-8xl  font-extrabold tracking-tight mb-6 leading-tight">
            اكتشف
            <span className="text-amber-500"> فن</span>
            <br className="hidden sm:inline" />
            التصوير الفوتوغرافي
          </h1>
          {/* Subtitle */}
          <p className="text-slate-300 text-[26px]  max-w-2xl mx-auto mb-10 leading-relaxed font-light">
            انغمس في أسرار المحترفين ونصائح عملية لتطوير مهاراتك في التصوير.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <a
              href="#"
              className="px-8 py-3.5 rounded-full bg-orange-500 text-white font-bold hover:-translate-y-2 duration-300 transition-all duration-200 shadow-lg shadow-amber-500/20"
            >
              استكشف المقالات
            </a>
            <a
              href="#"
              className="px-8 py-3.5 rounded-full bg-slate-800/60 text-white font-medium border border-slate-700 hover:bg-orange-500/10 hover:text-orange-500 hover:border-orange-500  transition-all duration-200 flex items-center gap-2 group"
            >
              <svg
                className="w-5 h-5 text-slate-400 group-hover:text-orange-500 "
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {/* Card 1 */}
            <div className="bg-amber-400/5 border border-amber-400/10 p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
              <div className="text-amber-400 mb-2">
                <FaRegNewspaper className="text-2xl text-orange-500 " />
              </div>
              <span className="text-2xl font-bold text-amber-500">+50</span>
              <span className="text-xs text-slate-400 mt-1">مقالة</span>
            </div>
            {/* Card 2 */}
            <div className="bg-amber-400/5 border border-amber-400/10  p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
              <div className="text-amber-400 mb-2">
              ...
              <span className="text-2xl font-bold text-amber-500">+10 ألف</span>
              <span className="text-xs text-slate-400 mt-1">قارئ</span>
            </div>
            {/* Card 3 */}
            <div className="bg-amber-400/5 border border-amber-400/10  p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
              <div className="text-amber-400 mb-2">
              ...
              <span className="text-xs text-slate-400 mt-1">تصنيفات</span>
            </div>
            {/* Card 4 */}
            <div className="bg-amber-400/5 border border-amber-400/10  p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
              <div className="text-amber-400 mb-2">
                <FaPenNib className="text-2xl text-orange-500 " />
              </div>
              <span className="text-2xl font-bold text-amber-500">6</span>
              <span className="text-xs text-slate-400 mt-1">كاتب</span>
            </div>
          </div>
        </div>
      </section>

      <section className="bg-[#0b0c0e] text-white py-12 px-4 sm:px-8 md:px-16">
        <div className="max-w-7xl mx-auto">
          {/* --- الهيدر العلوي للقسم --- */}
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
            <div>
              {/* شارة مميز */}
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-700/15 border border-amber-700 text-sm mb-8 text-amber-400">
                <div className="flex items-center gap-2">
                  <i class="fa-solid fa-circle  text-amber-700 text-[6px] "></i>
                ...
                <span className="text-orange-500 text-lg">مميز</span>
              </div>

              <h2 className="text-8xl md:text-7xl font-extrabold mb-2 text-white">
                مقالات مختارة
              </h2>
              <p className="text-zinc-400 text-sm md:text-base">
                محتوى انتقي لبدء رحلة تعلمك
              </p>
            </div>

            {/* زر عرض الكل */}
            <button className="bg-[#f95721] hover:bg-orange-600 text-white text-sm font-medium px-5 py-2.5 rounded-xl flex items-center gap-2 transition-colors">
              <span>عرض الكل</span>
            </button>
          </div>
   ...
   <div className="bg-[#121418] border border-zinc-800/80 rounded-2xl overflow-hidden flex flex-col lg:flex-row-reverse w-full hover:border-amber-700/40 duration-300 group mb-7 ">
            {/* الجزء الأيمن: تفاصيل المقال */}
            <div className="p-6 sm:p-8 w-full lg:w-1/2 flex flex-col justify-between">
              <div>
                {/* شارة التصنيف ومدة القراءة */}
                <div className="flex items-center gap-3 text-xs mb-5">
                  <span className="bg-orange-500/10 text-orange-500 px-3 py-1 rounded-full border border-orange-500/20 font-medium">
                    {x.category}
                  </span>
                ...
                {/* عنوان المقال */}
                <h3 className="text-3xl font-bold mb-3 text-white leading-snug group-hover:text-orange-500 duration-200">
                    {x.title}
                </h3>
              ...
              <div className="flex items-center justify-between  pt-5 mt-auto">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">{x.date}</p>
                  </div>
                </div>

                <a
                  href="#"
                  className="text-orange-500 hover:text-orange-400 text-sm font-medium flex items-center gap-2 transition-colors"
                >
            ...
            {/* الجزء الأيسر: الصورة والشارة (تم ضبط bg-zinc-900 للحاوية لمنع أي بياض) */}
            <div className="relative w-full lg:w-1/2 min-h-[250px] lg:min-h-[350px] bg-zinc-900 flex-shrink-0 overflow-hidden">
              <img
                src={x.image}
                alt="إتقان تصوير الساعة الذهبية"
                className="w-full h-full object-cover absolute inset-0 group-hover:scale-105 duration-500"
              />
              {/* شارة مميز على الصورة */}
              <div className="absolute top-4 right-4 bg-orange-500 text-white text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1 shadow-lg z-10 ">
                <span>★</span>
                <span>مميز</span>
              </div>
            </div>
         ...
         <section className="bg-[#121214] text-white py-16 px-4" dir="rtl">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        {/* Badge - التصنيفات */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-700/10 border border-amber-700 text-sm mb-8 text-amber-400">
            ...
            <span className="text-amber-600"> التصنيفات  </span>
          </div>
        ...
        <p className="text-zinc-400 text-lg sm:text-base mb-12">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {/* كارت 1: إضاءة */}
                        ...
                        <Link to="blog" className="w-full max-w-xs bg-[#1f1f22]/80 border border-zinc-700/50 hover:bg-orange-400 group rounded-2xl p-5 flex flex-col items-start text-right transition-all cursor-pointer hover:-translate-y-2 duration-400" >
      
      {/* Icon */}
      <div className="w-12 h-12 rounded-xl bg-amber-600/10 border border-amber-700/20 text-amber-600 flex items-center justify-center mb-4 group-hover:text-white group-hover:border-0 group-hover:bg-amber-200/30">
      ...
      {/* Count */}
      <span className="text-sm text-zinc-400 font-medium group-hover:text-white">
    ...
    {/* card-3 */}
                        ...
                        <Link className="w-full max-w-xs bg-[#1f1f22]/80 border border-zinc-700/50 hover:bg-orange-400 group rounded-2xl p-5 flex flex-col items-start text-right transition-all cursor-pointer hover:-translate-y-2 duration-400" to="blog" >
  ...
  <section className="bg-black/95 relative text-white py-12 px-4 min-h-screen font-sans" dir="rtl">
  <div className="absolute top-32 left-20 w-[350px] h-[350px] bg-orange-400 rounded-full blur-[140px] opacity-18 pointer-events-none z-0"></div>
      <div className="max-w-7xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-700/15 border border-amber-700 text-sm mb-8 text-amber-400">
                <div className="flex items-center gap-2">
                  <i class="fa-solid fa-circle  text-amber-700 text-[6px] "></i>
                ...
                <span className="text-orange-500 text-lg">الاحدث</span>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
          ...
          <div>
            <h2 className="text-7xl font-extrabold text-white mb-2">
              أحدث المقالات
            </h2>
          ...
          <a
            href="#"
            className="group inline-flex items-center gap-2 text-[#f97316] font-semibold text-sm md:text-base transition-colors hover:text-[#fb923c]"
          >
            <span>عرض جميع المقالات</span>
            <HiArrowLeft className="w-5 h-5 transition-transform duration-300 group-hover:-translate-x-2" />
          </a>
        </div>

        {/* الكروت ثابتة بدون Loop ولا Arrays */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

            {posts.filter(function(i){
                return i.id>=4 && i.id<=6
            })
            .map(function(i){
                return(
                       <Link to={`/blog/${i.slug}`} className="group bg-gray-500/10 border border-gray-800/80 rounded-2xl overflow-hidden flex flex-col justify-between  cursor-pointer transition-all  hover:border-gray-700 hover:shadow-xl hover:-translate-y-1 duration-400">
            
              <div className="relative h-52 w-full overflow-hidden rounded-t-2xl bg-gray-900 mb-4 ">
                <img
                  src={i.image}
                  alt="post"
                ...
                />
                <span className="absolute top-3 right-3 bg-black/90 backdrop-blur-md text-white text-xs font-medium px-3 py-1 rounded-full ">
                    {i.category}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400 mb-3 ">
                ...
                <span>•</span>
                <span>{  new Date (i.date).toLocaleDateString("ar-EG",{day:'numeric' , month:'long' , year:'numeric'})}</span>
              </div>

              <h3 className="text-xl font-bold text-white mb-2 leading-snug transition-colors duration-300 group-hover:text-[#f97316] ">
                {i.title}
              </h3>
            ...
            <div className="flex items-center justify-between p-4 border-t border-gray-800/60 mt-auto">
              <div className="flex items-center gap-3">
                <img
                  src={i.author.avatar}
                  alt="avatar"
                ...
                />
                <div>
                  <h4 className="text-sm font-semibold text-white leading-none mb-1"> {i.author.name}</h4>
                  <p className="text-xs text-gray-400 leading-none"> {i.author.role} </p>
                </div>
              </div>

              <div className="w-8 h-8 rounded-full bg-orange-600/10 flex items-center justify-center text-orange-600 border border-orange-600 transition-all duration-300 group-hover:bg-[#f97316] group-hover:text-white group-hover:scale-105">
     ...
     <section 
      className="relative w-full min-h-screen bg-[#0f0f12] flex items-center justify-center p-6 overflow-hidden" 
     
    >
      {/* خلفية الإضاءة الحمراء (Glow Effect) خلف الكارت */}
      <div className="absolute w-[500px] h-[500px] bg-orange-500/20 rounded-full blur-[140px] pointer-events-none -z-0" />

      {/* كارت النشرة الإخبارية */}
      <div className="relative z-10 bg-[#1a1b23]/90 backdrop-blur-sm w-full max-w-3xl rounded-3xl p-8 sm:p-12 text-center text-white border border-gray-800/80 shadow-2xl">
        
        {/* الأيقونة */}
        <div className="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white shadow-md">
        ...
        {/* الفورم مع validation المتصفح التلقائي */}
        <form onSubmit={(e) => e.preventDefault()} className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
          <input
            type="email"
            required
            placeholder="أدخل بريدك الإلكتروني"
            className="w-full bg-gray-700/15 text-right text-white placeholder-gray-500 px-5 py-3.5 rounded-xl border border-gray-700/70 outline-none focus:border-orange-600"
          />
          <a href="#?" 
            type="submit"
            className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-3.5 rounded-xl whitespace-nowrap transition-colors"
          >
            اشترك الآن
          </a>
        </form>
        ...
        {/* الجزء السفلي */}
        <div className="mt-8 pt-6 border-t border-gray-800/80 flex flex-wrap items-center justify-between gap-4 text-xs text-gray-400 max-w-md mx-auto">
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2 space-x-reverse">
              <img className="w-7 h-7 rounded-full border-2 border-[#1a1b23] object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80" alt="avatar" />
              <img className="w-7 h-7 rounded-full border-2 border-[#1a1b23] object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80" alt="avatar" />
              <img className="w-7 h-7 rounded-full border-2 border-[#1a1b23] object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80" alt="avatar" />
            </div>
