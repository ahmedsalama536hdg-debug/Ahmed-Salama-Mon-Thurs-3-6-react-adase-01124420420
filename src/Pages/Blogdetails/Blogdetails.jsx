...
window.scrollTo({
  ...
  console.log(333333333333, currentt);
  ...
  return (
    <>
      ...
      >
        <span className="py-1 px-4 bg-gray-800/70 mt-72 absolute -top-64 z-50 right-6  border border-gray-600/20  rounded-full ">
          <Link className="ml-3 " to="/">
            <i className="fa-solid fa-house text-gray-500 hover:text-white"></i>
          </Link>
          <span className="text-gray-500 text-xl">{">"}</span>
          <Link to={"/blog"} className="text-gray-400 mx-3 hover:text-white">
            المدونة
          </Link>
          <span className="text-gray-500 text-xl">{">"}</span>
          <span className="text-orange-600 mr-3">{currentt.category}</span>
        </span>
        <div className="py-32 px-60 text-white/70 text-sm font-semibold">
          <span className="text-white ml-3 py-2 px-3.5 rounded-full bg-orange-500">
            {currentt.category}
          </span>
          <i className="fa-regular fa-calendar ml-2"></i>
          <span className="ml-3">{date}</span>
          <i className="fa-regular fa-clock ml-2"></i>
          <span>{currentt.readTime}</span>
          <p className="text-white text-6xl my-10">{currentt.title}</p>
          <div className="border border-gray-400/20 p-4 pl-3 bg-gray-700/40 rounded-2xl flex w-48 items-center justify-start gap-3">
            <img
              src={currentt.author.avatar}
              className="h-10 w-10 rounded-full border border-orange-600"
              alt=""
            />
            <div>
              <div className="text-white ">{currentt.author.name}</div>
              <div className="text-gray-300/80 text-[12px]">
                {currentt.author.role}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-black/96 py-12">
          ...
          <div className="col-span-9  text-white px-8">
            ...
            <div className="text-xl border border-gray-500/20 rounded-2xl p-7 bg-gray-700/20">
              ...
              <div className="mt-5 mb-5">
                <span className="text-gray-400  rounded-full px-3 py-2 ml-2 hover:border-amber-600 hover:text-orange-500 text-sm  bg-gray-500/10 border border-gray-500/15 ">
                  #{currentt.tags[0]}
                </span>
                <span className="text-gray-400  rounded-full px-3 py-2 ml-2 hover:border-amber-600 hover:text-orange-500 text-sm  bg-gray-500/10 border border-gray-500/15 ">
                  #{currentt.tags[1]}
            ...
            <div className="text-xl mt-7 border flex items-center justify-between border-gray-500/20 rounded-2xl p-6 bg-gray-700/20">
              <div>
                <div className="text-lg p-2 text-orange-500  bg-amber-600/10 border border-amber-500/50 rounded-xl inline">
              ...
              <div className="flex gap-3 text-gray-400/40">
                <a
                  className="hover:text-white bg-gray-400/10 hover:bg-blue-500 rounded-lg p-2 "
            ...
            <div className="text-xl mt-7 border flex items-center gap-4  border-gray-500/20 rounded-2xl p-8 bg-gray-700/20">
              <img
                src={currentt.author.avatar}
                className="w-24 h-24 rounded-xl border-2 border-orange-800/50"
                alt=""
              />
              <div>
                <div className="text-orange-600 text-sm">كاتب المقال</div>
                <div className="text-white text-2xl">
                  {currentt.author.name}
                </div>
          ...
          <div className="col-span-3 sticky top-24 self-start">
            ...
            <div className="border my-7 border-gray-500/20 rounded-2xl p-2 xl:py-7 px-2 bg-gray-700/20 flex items-center justify-center gap-2">
              <div className="bg-black/90 rounded-xl py-6 px-3 text-center">
                ...
                <div className="text-gray-400/80 text-sm mt-1">وقت للقراءة</div>
              </div>
        ...
        <div className=" border-gray-500/20 border  mt-20 mb-8 mr-44 w-[79%] "></div>
      </section>

      {/* like Section */}
      <section className="bg-black/96 ">
        <div className="w-[87%] mx-auto gap-3 px-14">
          <div className="flex items-center justify-between">
            <div className="flex items-center mb-10 gap-5">
              <div className="text-2xl px-3 py-2 text-orange-500  bg-amber-600/10 border border-amber-500/50 rounded-2xl inline">
                <i className="fa-solid fa-tags"></i>
              </div>
              <div>
            ...
            <Link to="/blog">
              ...
              >
                عرض الكل
                <i className="fa-solid fa-arrow-left-long text-sm group-hover:-translate-x-1.5 transition-transform  duration-200"></i>
              </button>
            </Link>
          </div>
                  ...
                  <Link to={`/blog/${current.slug}`}>
                    <div className="relative overflow-hidden w-full rounded-t-3xl ">
                      <img
                        ...
                        alt={current.slug}
                      />
                      <div className="absolute top-5 right-5 bg-orange-600 text-white rounded-2xl py-1 px-3 text-[11px] font-semibold">
                        {current.category}
                      </div>
                    </div>

                    <div className="sm:p-7 md:p-8 md:pb-10 lg:p-7  lg:pb-4 bg-zinc-900/80 rounded-b-3xl">
                      <div className=" font-semibold mb-3 text-white group-hover:text-orange-600">
                        {current.title}
                      </div>

                      <div className="flex items-center text-gray-300/50 justify-between ">
                        ...
                        <div className="text-sm">{currentt.readTime}</div>
                      </div>
                    </div>
                  </Link>
                </div>
