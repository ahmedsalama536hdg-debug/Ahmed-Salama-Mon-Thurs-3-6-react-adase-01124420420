...
export default function Blog() {
  const [allData, setallData] = useState({
    ...
    categories: [
      { name: "جميع المقالات", count: 28, color: "emerald" },
      { name: "إضاءة", count: 4, color: "emerald" },
      { name: "بورتريه", count: 6, color: "purple" },
      { name: "مناظر طبيعية", count: 4, color: "blue" },
      { name: "تقنيات", count: 9, color: "orange" },
      { name: "معدات", count: 5, color: "emerald" },
    ],
    siteInfo: {
      name: "عدسة",
...
let filterCategory = posts.filter((dataCategory)=>{
  let matheCategory =  activeCategory === dataCategory.category || activeCategory === "جميع المقالات";
let search =  dataCategory.title.toLocaleLowerCase().includes(searchInput.toLocaleLowerCase()) || dataCategory.category.toLocaleLowerCase().includes(searchInput.toLocaleLowerCase())
return matheCategory && search
})

let updateFilterCategory = filterCategory.slice(0,6)  
  ...
  return (
    <>
      <section
        id="?"
        className="relative bg-black text-white  flex flex-col justify-center items-center   overflow-hidden pt-14 "
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          {/* Top Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-700/10 border border-amber-700 text-sm mb-3 text-amber-400">
            <div className="flex items-center gap-2">
              <i class="fa-solid fa-circle fa-fade text-amber-700 text-[9px] drop-shadow-[0_0_8px_rgba(217,119,6,0.8)]"></i>
            </div>
            <HiOutlineNewspaper className="text-amber-700" />

            <span className="text-white"> مدونتنا</span>
          </div>
          {/* Main Heading */}
          <h1 className="text-8xl  font-extrabold tracking-tight  leading-tight">
            استكشف
            <span className="text-amber-500"> مقالاتنا</span>
          </h1>
          {/* Subtitle */}
          <p className="text-slate-300 text-[24px]  max-w-2xl mx-auto mb-10 leading-relaxed font-light">
            اكتشف الدروس والرؤى وأفضل الممارسات للتطوير الحديث
          </p>
        </div>
      </section>

      <section className="bg-black/95 text-gray-200 dir-rtl p-5 ">
        <div className="max-w-7xl mx-auto space-y-6">
          {/* 1. أزرار الفئات ومربع البحث */}
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-4">
            {/* حقل البحث */}
            <div className="relative w-full lg:w-80">
              <input
                value={searchInput}
                onChange={(search) => setserchInput(search.target.value)}
                type="text"
                placeholder="ابحث في المقالات..."
                className="w-full bg-[#1a212b] text-sm text-gray-200 placeholder-gray-500 py-2.5 pr-10 pl-4 rounded-xl border border-gray-800/80 focus:outline-none focus:border-amber-500 transition"
              />
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
              {categories.map((i) => (
                <button type="button" onClick={ ()=> setactiveCategory(i.name)} className={`px-5 py-2.5 rounded-xl text-sm font-semibold border border-gray-400/30 cursor-pointer
                ${activeCategory === i.name ? "text-white bg-orange-500" : " bg-gray-500/10 text-white/60" }`}>
                  {i.name}
                </button>
              ))}
            </div>
          </div>
          <div className="border border-amber-50/5 "></div>

          {/* 2. شريط عدد المقالات وطريقة العرض */}
          <div className="flex items-center justify-between pt-2">
            ...
            {/* أزرار نمط العرض */}
            <div className="flex items-center gap-1.5 bg-gray-300/5 p-1 rounded-xl border border-gray-800">
              <button className="p-2 rounded-lg bg-orange-500 text-white">
                <HiSquares2X2 className="text-xl" />
              </button>
              <button className="p-2 rounded-lg text-gray-400 hover:text-white transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {updateFilterCategory.map(function (i) {
                return (
                  <Link
                    to={`/blog/${i.slug}`}
                    className="group bg-gray-500/10 border border-gray-800/80 rounded-2xl overflow-hidden flex flex-col justify-between  cursor-pointer transition-all  hover:border-gray-700 hover:shadow-xl hover:-translate-y-1 duration-400"
                  >
