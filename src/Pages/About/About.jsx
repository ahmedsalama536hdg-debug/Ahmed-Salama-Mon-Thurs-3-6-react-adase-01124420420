          ...
          <div className="absolute top-32 left-32 w-[350px] h-[350px] bg-orange-400 rounded-full blur-[140px] opacity-26 pointer-events-none z-0"></div>
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-7xl  font-extrabold tracking-tight mb-6 leading-tight">
                مهمتنا هي
                <span className="text-amber-500"> الإعلام والإلهام</span>
               
              </h1>
              {/* Subtitle */}
              <p className="text-slate-300 text-[20px]  max-w-2xl mx-auto mb-10 leading-relaxed font-light">
مدونة متخصصة في فن التصوير الفوتوغرافي، نشارك معكم أسرار المحترفين ونصائح عملية لتطوير مهاراتكم. نحن شغوفون بمشاركة المعرفة ومساعدة المصورين على تنمية مهاراتهم من خلال محتوى عالي الجودة              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-9xl mx-auto">
                ...
                {/* Card 1 */}
                <div className="bg-amber-400/5 border border-amber-400/10  py-6 px-15 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
                  <div className="text-amber-400 mb-2">
                    <HiUserGroup className="text-2xl text-orange-500 " />
                  </div>
                  <span className="text-2xl font-bold text-amber-500">+2مليون</span>
                  <span className="text-xs text-slate-400 mt-1">قارئ شهرياً
</span>
                </div>
                ...
                <div className="bg-amber-400/5 border border-amber-400/10 p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
                  ...
                  <span className="text-2xl font-bold text-amber-500">قارئ شهرياً
</span>
                  <span className="text-xs text-slate-400 mt-1">مقالة منشورة
</span>
                </div>
                ...
                <div className="bg-amber-400/5 border border-amber-400/10  p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
                  ...
                  <span className="text-2xl font-bold text-amber-500">+50
</span>
                  <span className="text-xs text-slate-400 mt-1">كاتب خبير
</span>
                </div>
                ...
                <div className="bg-amber-400/5 border border-amber-400/10  p-5 rounded-2xl backdrop-blur-sm flex flex-col items-center hover:scale-105 duration-300">
                  ...
                  <span className="text-xs text-slate-400 mt-1">تصنيف</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-[#121214] text-white py-16 px-4 text-center" >
       <div className='flex items-center gap-2 justify-center'>
        <span className='w-2 h-11 rounded-2xl bg-orange-400'></span>
...
المبادئ التي توجه كل ما نقوم بإنشائه
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
                ...
                {/* Card 1 */}
              <div className="hover:bg-amber-400/5 border border-gray-600/15 group hover:border-amber-400/10 p-7 rounded-2xl backdrop-blur-sm flex flex-col items-center  duration-300 ">
                  <div className="text-amber-400 mb-2">
                    <FaBullseye   className="text-4xl text-orange-500 " />
                  </div>
                  <span className="text-2xl font-bold group-hover:text-amber-500">الجودة أولاً

</span>
                  <span className="text-xs text-slate-400 mt-1">محتوى مدروس ومكتوب بخبرة
                ...
                <div className="hover:bg-amber-400/5 border border-gray-600/15 group hover:border-amber-400/10 p-7 rounded-2xl backdrop-blur-sm flex flex-col items-center  duration-300 ">
                  <div className="text-amber-400 mb-2">
                    <HiOutlineBolt  className="text-4xl text-orange-500 " />
                  </div>
                  <span className="text-2xl font-bold group-hover:text-amber-500"> تركيز عملي

</span>
                  <span className="text-xs text-slate-400 mt-1">أمثلة واقعية يمكنك تطبيقها اليوم
                ...
                <div className="hover:bg-amber-400/5 border border-gray-600/15 group hover:border-amber-400/10 p-7 rounded-2xl backdrop-blur-sm flex flex-col items-center  duration-300 ">
                  <div className="text-amber-400 mb-2">
                    <FaHandshakeSimple   className="text-4xl text-orange-500 " />
                  </div>
                  <span className="text-2xl font-bold group-hover:text-amber-500"> المجتمع

</span>
                  <span className="text-xs text-slate-400 mt-1"> تعلم مع آلاف المصورين
                ...
                <div className="hover:bg-amber-400/5 border border-gray-600/15 group hover:border-amber-400/10 p-7 rounded-2xl backdrop-blur-sm flex flex-col items-center  duration-300 ">
                  <div className="text-amber-400 mb-2">
                    <LuRefreshCw   className="text-4xl text-orange-500 " />
                  </div>
                  <span className="text-2xl font-bold group-hover:text-amber-500">دائماً محدث
 
</span>
                  <span className="text-xs text-slate-400 mt-1">أحدث الاتجاهات وأفضل الممارسات
              ...
              <section className="bg-black text-white py-16 px-4" dir="rtl">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto mb-12">
          فريقنا من المصورين والكُتّاب ذوي الخبرة شغوفون بمشاركة معرفتهم مع المجتمع.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
         ...
         {posts.map(function(post){
          return(
            <div className="bg-[#24272c]/60 border border-gray-700/50 rounded-2xl p-6 flex flex-col items-center backdrop-blur-sm hover:border-orange-500/30 duration-200 group">
            <div className="relative mb-4">
              <img
                src={post.author.avatar}
                alt="profile"
                className="w-24 h-24 rounded-full object-cover border-4 border-gray-600 group-hover:border-orange-400/30 duration-200"
              />
              <span className="absolute bottom-1 right-1 w-4 h-4 bg-orange-500 border-2 border-[#1a1c1e] rounded-full"></span>
            </div>
            ...
            <div className="flex items-center gap-2">
              <a href="#" className="w-9 h-9 bg-[#32363c] hover:bg-orange-500  text-gray-300 rounded-lg flex items-center justify-center transition-colors text-sm">
                <FaXTwitter />
              </a>
              <a href="#" className="w-9 h-9 bg-[#32363c] hover:bg-[#26292e]  text-gray-300 rounded-lg flex items-center justify-center transition-colors text-sm">
                <FaGithub />
              </a>
             
               <a href="#" className="w-9 h-9 bg-[#32363c] hover:bg-sky-500  text-gray-300 rounded-lg flex items-center justify-center transition-colors text-sm">
                <FaLinkedinIn />
              </a>
            </div>
          </div>
...
<section>
<div className='p-5  bg-orange-400 text-center '>
    <h1 className="text-5xl  font-extrabold tracking-tight mb-6 leading-tight text-white">
                 لديك أسئلة؟ دعنا نتحدث!
                   ...
                   <p className="text-white text-[20px]  max-w-2xl mx-auto mb-10 leading-relaxed font-light">
...
<div className="flex flex-wrap justify-center gap-4 mb-16">
            <Link
              to="#"
              className="px-8 py-3.5 rounded-2xl bg-black text-white font-bold hover:-translate-y-1  transition-all duration-300 shadow-lg shadow-amber-500/20"
            >
              تواصل معنا
            </Link>
            <Link
              to="/blog"
              className="px-8 py-3.5 rounded-2xl bg-transparent text-white font-medium border border-white hover:bg-white hover:text-black  transition-all duration-200 flex items-center gap-2 group"
            >
